...
ALTER VIEW VSZOBA AS /* modosítja vagy CREATE OR ALTER VIEW megcsinálja vagy alakítja*/
SELECT sz.*,
...
(@fazon int)
RETURNS INT /*visszaadott tipus*/
AS
BEGIN
/*RETURN/*visszaadott érték*/(
SELECT sz.FEROHELY
FROM Foglalas f JOIN Szoba sz ON f.SZOBA_FK=sz.SZOBA_ID
WHERE f.FOGLALAS_PK = @fazon) csunya megoldás*/
DECLARE @ferohely INT /* változó létrehozása*/
